# gh-scout Architecture Specification
...
var searchCmd = &cobra.Command{
    ...
    Example: heredoc.Doc(`
        ...
        gh scout "vite.config" --language javascript --save vite-configs

        # Compare different approaches
        gh scout "eslint.config.js" --compare --highlight-differences
    `),
